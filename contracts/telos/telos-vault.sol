...
contract MesoVault is ERC20, Ownable, ReentrancyGuard {
    ...
    function deposit(uint _amount) public nonReentrant {
        ...
        require(_amount > 0,"Call the function with amount greater than 0");
        
        strategy.beforeDeposit();
        
        console.log("Amount Before transfer");
        console.log(_amount);
        ...
        console.log(_amount);
        earn(_amount);
        console.log("DO I Break Before This?");

        _amount = balance().sub(_pool);
        console.log("Amount After Strat Deposit");
        console.log(_amount);
        uint256 shares = 0;
    ...
    function earn(uint256 _amount) internal {
        ...
        console.log("trying to move: {0}", _amount)
        uint256 before = input().balanceOf(address(strategy));
        console.log("check the balance of LP on strategy");
        console.log(before);
        input().safeTransfer(address(strategy), _amount);
        
        _amount = input().balanceOf(address(strategy)).sub(before);
        console.log("calculated Amount after subtracting strat balance");
        console.log(_amount);
        strategy.deposit(_amount);
        console.log("Do I Die here??");
    }
